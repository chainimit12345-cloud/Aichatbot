    ...
    APP_DATA.contact.phones.forEach((phone) => {
      phonesHTML += `
            <a href="${phone.link}" class="flex items-center justify-between group cursor-pointer relative block hover:bg-white p-1.5 -m-1.5 rounded-lg transition-all duration-300 mb-2 overflow-hidden">
                ...
                <span class="absolute right-2 top-1/2 -translate-y-1/2 text-[9px] font-medium text-white bg-green-500 px-2 py-1 rounded shadow-sm opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-300 z-10 whitespace-nowrap">แตะเพื่อโทร</span>
            </a>`;
    });
            ...
            <div class="space-y-1">
                ...
                <div class="mt-3">
                    <a href="${APP_DATA.contact.emailLink}" class="flex items-center justify-between group cursor-pointer relative block hover:bg-white p-1.5 -m-1.5 rounded-lg transition-all duration-300 mb-2 overflow-hidden">
                        ...
                        <span class="absolute right-2 top-1/2 -translate-y-1/2 text-[9px] font-medium text-white bg-blue-500 px-2 py-1 rounded shadow-sm opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-300 z-10 whitespace-nowrap">แตะส่ง</span>
                    </a>
                </div>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
          <div class="mb-1">
              <p class="text-[13px] text-gray-800 font-bold mb-3"><i class="fa-solid fa-clipboard-list text-primary mr-1"></i> กรุณาเลือกแบบฟอร์มเอกสารที่ต้องการดาวน์โหลดค่ะ</p>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
              <div class="mb-1">
                  <p class="text-[13px] text-gray-800 font-bold mb-2"><i class="fa-regular fa-file-lines text-primary mr-1"></i> แบบคําขอรับเงินสงเคราะห์และรับรองผู้รับผิดชอบในการจัดการศพผู้สูงอายุตามประเพณี (ศผส. 01)</p>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
              <div class="mb-1">
                  <p class="text-[13px] text-gray-800 font-bold mb-2"><i class="fa-regular fa-file-lines text-primary mr-1"></i> แบบคำขอมีบัตรประจำตัวคนพิการ</p>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
              <div class="mb-1">
                  <p class="text-[13px] text-gray-800 font-bold mb-2"><i class="fa-regular fa-file-lines text-primary mr-1"></i> แบบรับรองการเปลี่ยนแปลงผู้ดูแลคนพิการ</p>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
              <div class="mb-1">
                  <p class="text-[13px] text-gray-800 font-bold mb-2"><i class="fa-regular fa-file-lines text-primary mr-1"></i> แบบฟอร์มคำร้องขอกู้ยืมประเภทบุคคล</p>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
              <div class="mb-1">
                  <p class="text-[13px] text-gray-800 font-bold mb-2"><i class="fa-regular fa-file-lines text-primary mr-1"></i> แบบคำขอรับความช่วยเหลือผู้ประสบปัญหาทางสังคม (ปสค.1)</p>
      ...
      return new Promise((resolve) =>
        setTimeout(
          () =>
            resolve(`
              <div class="mb-1">
                  <p class="text-[13px] text-gray-800 font-bold mb-2"><i class="fa-regular fa-file-lines text-primary mr-1"></i> แบบสอบถามความต้องการและคำขอปรับปรุง/ซ่อมแซมที่อยู่อาศัยของผู้สูงอายุ</p>
